...
@interface EDownloadServiceManager ()<CLLocationManagerDelegate>

@property(strong, nonatomic) NSMutableData *mutableData;

@end

@implementation EDownloadServiceManager

+ (instancetype)sharedInstance
{
    static EDownloadServiceManager * shared = nil;
    if (!shared)
    {
